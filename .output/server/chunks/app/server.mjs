...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-7445e209.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div class="flex flex-row w-full top-[35%] left-0 fixed z-30"><ul class="hidden desktop:block"><!--[-->`);
