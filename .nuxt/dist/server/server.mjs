import { effectScope, reactive, hasInjectionContext, getCurrentInstance, version, unref, inject, ref, watchEffect, watch, toRef, h, nextTick, shallowRef, shallowReactive, isReadonly, markRaw, toRaw, isRef, isReactive, computed, getCurrentScope, onScopeDispose, toRefs, defineComponent, resolveComponent, isShallow, provide, Suspense, mergeProps, Transition, useSSRContext, onUnmounted, withCtx, createVNode, createTextVNode, openBlock, createBlock, createCommentVNode, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash, withLeadingSlash, encodeParam, encodePath } from "ufo";
import "destr";
import { defu } from "defu";
import "klona";
import { setupDevtoolsPlugin } from "@vue/devtools-api";
import "devalue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderClass, ssrRenderAttr, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
import { FaCode, FaTimes, FaBars, FaGithub, FaLinkedin, FaQuestion } from "vue3-icons/fa/index.esm.js";
import { AiOutlineHome } from "vue3-icons/ai/index.esm.js";
import { HiMail } from "vue3-icons/hi/index.esm.js";
import { BsFillPersonLinesFill, BsArrowUp } from "vue3-icons/bs/index.esm.js";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/about-6f68c5a5.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-f4244e5f.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-8d22908d.js").then((m) => m.default || m)
};
...
const Loader_vue_vue_type_style_index_0_scoped_63333af8_lang = "";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-45384f97.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-5d7b73b4.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-c4f1023b.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
