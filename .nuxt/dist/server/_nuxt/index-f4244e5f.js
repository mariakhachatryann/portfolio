import { mergeProps, unref, useSSRContext, withCtx, createVNode, createTextVNode, getCurrentScope, onScopeDispose, watch, ref, onUnmounted } from "vue";
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrRenderComponent, ssrInterpolate, ssrRenderStyle, ssrRenderClass } from "vue/server-renderer";
...
import { a as __nuxt_component_0$3, b as __nuxt_component_0$4, d as defineStore, e as __nuxt_component_1$3, _ as _export_sfc } from "../server.mjs";
...
const _sfc_main$8 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg"><div class="pb-8"><h2 class="text-4xl sm:text-5xl font-bold inline border-b-4 border-primary-color/40">About me</h2></div><p class="mb-4 py-6"> 👋 Hi there! I&#39;m a motivated and hardworking front-end developer with a focus on Vue.js and Nuxt.js. I quickly perceive new information, have a desire to learn, ability to solve problems and creative thinking․ I am confident that I can quickly adapt to new technologies, trends and team. I enjoy turning cool ideas into awesome digital stuff using neat code. <br><br> 🚀 Proficient in HTML, CSS, JavaScript, and Vue.js/Nuxt.js, I&#39;m adept at translating design concepts into functional interfaces. I believe in writing clean, maintainable code that prioritizes readability and scalability. <br><br> 💡 I thrive on learning and adapting, constantly seeking new challenges to expand my skill set. Whether it&#39;s mastering responsive design principles or diving into the latest frameworks, I&#39;m always eager to grow and evolve in this dynamic field. <br><br> 🌟 I&#39;m deeply committed to my work, ensuring every task is approached with responsibility and dedication. My ability to quickly grasp new concepts allows me to adapt and learn on the go, consistently enhancing my skills to deliver high-quality results. </p><p> 📫 Let&#39;s connect and create something amazing ! Feel free to reach out—I&#39;m excited to collaborate and contribute to innovative web experiences. </p><br><br>`);
...
const _sfc_main$7 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtImg = __nuxt_component_0$4;
...
//# sourceMappingURL=index-f4244e5f.js.map
