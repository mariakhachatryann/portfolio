...
import { useSSRContext, ref, onUnmounted, mergeProps, unref, withCtx, createTextVNode, createVNode, watch, getCurrentScope, onScopeDispose } from 'vue';
...
import { _ as __nuxt_component_0$3 } from './nuxt-link-52e762fb.mjs';
...
const tourScreen = "" + buildAssetsURL("tour-screen.363938b7.png");
const quizScreen = "" + buildAssetsURL("quiz-screen.abc039cc.png");
const weatherScreen = "" + buildAssetsURL("weather-screen.7d15e592.png");
const editorScreen = "" + buildAssetsURL("editor-screen.f323422a.png");
const projects = [
  {
    id: 1,
    title: "Quiz Game",
...
//# sourceMappingURL=index-1a156d2c.mjs.map
