<template>
    <section class="fixed inset-0 flex items-center justify-center bg-opacity-70 bg-black z-40 over">
        <div ref="modal"
            ...
            <div>
                <img class="w-full rounded-tl-lg rounded-tr-lg md:object-cover" :src="props.SelectedProject.src"
                    alt="Resident image" />
            </div>

            <div
                class="w-full text-white p-8 flex flex-col bg-black/80 border-opacity-70 border-primary-color rounded-bl-lg rounded-br-lg">
